(function () {
    ...
    var WorkOutController = function ($scope, $interval, $location, $sce, workoutHistoryTracker) {
        ...
        var WorkoutPlan = function (args) {
            ...
            self.restBetweenExercise = args.restBetweenExercise;

            self.totalWorkDuration = function () {
                ...
                var totalTime = self.restBetweenExercise * (self.exercises.length - 1) + total;
        ...
        var startWorkout = function () {
            ...
            $scope.workoutTimeRemaining = $scope.workoutPlan.totalWorkDuration();
        ...
        var startExercise = function (exercisePlan) {
            ...
            var handleNextExercise = function () {
            ...
            exerciseIntervalPromise = startExerciseTimeTracking(handleNextExercise);
        };

        var incrementExercise = function () {
        ...
        var startExerciseTimeTracking = function (handleNextExercise) {

            var promise = $interval(incrementExercise, 1000, $scope.currentExercise.duration );
            ...
            promise.then(handleNextExercise, promiseError);
        ...
        //watch the currentExerrcise Duration and whenever it reaches the total duration of the current exercise
        // retrieve the next exercise and then start the next exercise
        // is the next exerise retrieved is null then the workout is complete
        // the watch approach results in a performance hint hence reduce it
    ...
    WorkOutController['$inject'] = ['$scope', '$interval', '$location', '$sce', "workoutHistoryTracker"];
